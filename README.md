...
- `up composition render --xrd=apis/xnetworks/definition.yaml apis/xnetworks/composition.yaml examples/xnetworks/configuration-aws-network.yaml` to render the composition
