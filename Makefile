# Project Setup
PROJECT_NAME := configuration-aws-network
...
uptest: $(UPTEST) $(KUBECTL) $(KUTTL)
	...
	@KUBECTL=$(KUBECTL) KUTTL=$(KUTTL) $(UPTEST) e2e examples/network-xr.yaml --data-source="${UPTEST_DATASOURCE_PATH}" --setup-script=test/setup.sh --default-timeout=2400 || $(FAIL)
...
render:
	crossplane beta render examples/network-xr.yaml apis/basic/composition.yaml examples/function/function.yaml -r -o examples/observed.yaml
